...
def test():
    ...
    print(
        ColoredText("Bold underline reverse cyan color", "cyan|bold|underline|reverse")
    )
    print(ColoredText("Dark blink concealed white color", "white|dark|blink|concealed"))
    print("-" * 78)

    print("Test mixing:")
    print(ColoredText("Underline red on grey color", "red|on_grey|underline"))
    print(ColoredText("Reversed green on red color", "green|on_red|reverse"))
