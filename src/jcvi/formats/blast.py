...
class AlignStats:
    """
    Stores the alignment statistics that is used in summary()
    """
...
def coords_filter(args):
    ...
    p = OptionParser(coords_filter.__doc__)
...
def get_coords_stats(coordsfile):
