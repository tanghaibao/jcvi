...
def exonunion(args):
    """
    %prog exonunion gencode.v27.annotation.exon.bed

    Collapse overlapping exons within the same gene. File
    `gencode.v27.annotation.exon.bed` can be generated by:

    $ zcat gencode.v27.annotation.gtf.gz |  awk 'OFS="\t" {if ($3=="exon")
    ...
    for g, gb in groupby(beds, lambda x: x.fields[3]):
        gb = BedTool(gb)
